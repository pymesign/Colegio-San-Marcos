...
?>
<div class="blog-detail <?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
    ...
    <div class="detail-content">
        ...
        <?php if ($useDefList && ($info == 0 || $info == 2)): ?>
            <div class="blog-info flex-container">
        ...
        <?php if ($params->get('show_title')): ?>
            <div class="page-header">
                <<?php echo $htag; ?> itemprop="headline" class="blog-title">
        ...
        <div class="button back">
            <a class="btn primary" href="javascript:history.back(1)">Volver</a>
        </div>
        <?php //endif; ?>
    </div>
</div>