    ...
    <?php foreach ($this->children[$this->category->id] as $id => $child) : ?>
        ...
        <?php if (in_array($child->access, $groups)) : ?>
            ...
            <div>
                ...
                <a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($child->id)); ?>"><img src="<?php echo $child->getParams()->get('image'); ?>" alt="<?php echo htmlspecialchars($child->getParams()->get('image_alt'), ENT_COMPAT, 'UTF-8'); ?>"/></a>
