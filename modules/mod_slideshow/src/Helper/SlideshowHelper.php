...
namespace Joomla\Module\Slideshow\Site\Helper;
 ...
 * @since  1.6
 */
class SlideshowHelper implements DatabaseAwareInterface
{
    ...
    public function getArticles(Registry $params, SiteApplication $app)
    {
        ...
        foreach ($items as &$item) {
            ...
            if ($access || \in_array($item->access, $authorised)) {
                ...
                $item->linkText = Text::_('MOD_SLIDESHOW_READMORE');
            } else {
                ...
                $item->linkText = Text::_('MOD_SLIDESHOW_READMORE_REGISTER');
            }

            $item->introtext = HTMLHelper::_('content.prepare', $item->introtext, '', 'mod_slideshow.content');
